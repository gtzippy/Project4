 ...
 * @author Daniel
 */
@Path("/GetAllPreferenceForStudent")
public class GetAllPreferenceForStudentResource extends ResourceBase {

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of GetAllPreferenceForStudentResource
     */
    public GetAllPreferenceForStudentResource() {
    }

    /**
     * Retrieves representation of an instance of
     * edu.gatech.sad.project4.Resources.GetAllPreferenceForStudentResource
     *
     ...
     * GetAllPreferenceForStudentResource
     *
