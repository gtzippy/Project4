...
public class DeleteRemoveStudentpreferenceResource extends ResourceBase{
    ...
    /**
     * Creates a new instance of DeleteRemoveStudentpreference
     */
    public DeleteRemoveStudentpreferenceResource() {
    }

    /**
     * Retrieves representation of an instance of
 edu.gatech.sad.project4.Resources.DeleteRemoveStudentpreferenceResource
     *
    ...
    public Response getJson(@PathParam("preferenceId") int preferenceId) {
        ...
        return Response.ok().header("Access-Control-Allow-Origin", "*").build();
            ...
            Logger.getLogger(DeleteRemoveStudentpreferenceResource.class.getName()).log(Level.SEVERE, null, ex);
 ...
 DeleteRemoveStudentpreferenceResource
     *
