...
public class DeleteRemoveStudentResource extends ResourceBase{
    ...
    /**
     * Creates a new instance of DeleteRemoveStudentResource
     */
    public DeleteRemoveStudentResource() {
    }

    /**
     * Retrieves representation of an instance of edu.gatech.sad.project4.Resources.DeleteRemoveStudentResource
    ...
    public Response getJson(@PathParam("studentId") int studentId) {
        try {
            ...
            Logger.getLogger(DeleteRemoveStudentResource.class.getName()).log(Level.SEVERE, null, ex);
            return Response.serverError().status(Response.Status.NOT_FOUND).type(ex.getMessage()).build();
        }
    }

    /**
     * PUT method for updating or creating an instance of DeleteRemoveStudentResource
