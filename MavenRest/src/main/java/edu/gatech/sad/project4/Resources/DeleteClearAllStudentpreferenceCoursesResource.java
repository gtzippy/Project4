 ...
 * @author Daniel
 */
@Path("/DeleteClearAllStudentpreferenceCourses")
public class DeleteClearAllStudentpreferenceCoursesResource extends ResourceBase{

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of DeleteClearAllStudentpreferenceCourses
     */
    public DeleteClearAllStudentpreferenceCoursesResource() {
    }

    /**
     * Retrieves representation of an instance of
     * edu.gatech.sad.project4.Resources.DeleteClearAllStudentpreferenceCourses
     *
     ...
     * DeleteClearAllStudentpreferenceCourses
     *
