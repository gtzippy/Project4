 ...
 * @author Daniel
 */
@Path("/PutChangeAdministratorPassword")
public class PutChangeAdministratorPasswordResource extends ResourceBase{

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of PutChangeAdministratorPasswordResource
     */
    public PutChangeAdministratorPasswordResource() {
    }

    /**
     * Retrieves representation of an instance of edu.gatech.sad.project4.Resources.PutChangeAdministratorPasswordResource
     * @return an instance of javax.ws.rs.core.Response
     */
    @GET
    @Path("{administratorId}/{newPassword}")
    ...
    /**
     * PUT method for updating or creating an instance of PutChangeAdministratorPasswordResource
